...
function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    ...
    >
      <Card className="h-full flex flex-col justify-start p-6 rounded-2xl shadow-lg hover:shadow-md transition-all duration-300 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 text-center group relative overflow-hidden">
          ...
          {service.details && service.details.length > 0 && (
            <ul className="text-left text-sm text-gray-600 dark:text-gray-400 space-y-3">
              {service.details.map((detail, index) => (
                ...
                >
                  <span className="text-primary mr-3 mt-1 group-hover/item:scale-110 transition-transform duration-200">
                    •
                  </span>
