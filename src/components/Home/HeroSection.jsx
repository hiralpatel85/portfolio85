  ...
  return (
    <div className="relative min-h-[calc(100vh-50px)] flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        >
          A passionate{" "}
          <strong className="text-primary">MERN Stack Developer</strong>{" "}
          crafting
        ...
        >
          <Link to="/portfolio">
            <Button className="bg-gradient-to-r from-primary to-accent text-white hover:from-primary-hover hover:to-accent/80 px-6 md:px-8 py-3 md:py-4 rounded-xl text-base md:text-lg font-semibold shadow-soft-lg hover:shadow-soft-md transition-all duration-300 group hover-lift">
              View My Work
          ...
          <Link to="/contact">
            <Button
              variant="outline"
              className="border-2 border-primary text-primary hover:bg-primary/10 dark:hover:bg-primary/20 px-6 md:px-8 py-3 md:py-4 rounded-xl text-base md:text-lg font-semibold shadow-soft-md hover:shadow-soft-lg transition-all duration-300 hover-lift"
            >
              Get in Touch
            </Button>
          </Link>
