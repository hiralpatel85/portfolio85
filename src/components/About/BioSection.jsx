...
function BioSection() {
  ...
  return (
    <motion.section
      className="relative select-none bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 p-4 sm:p-6 md:p-8 rounded-3xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden"
      ...
      <div className="relative flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8">
        <motion.div variants={imageVariants} className="flex-shrink-0 relative">
          <div className="relative">
            <img
              ...
              className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full object-cover border-4 border-gradient-to-r from-primary to-accent shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105"
            />
        ...
        <div className="text-center md:text-left flex-1">
          ...
          >
            ...
            dedicated{" "}
            <strong className="text-gradient">MERN Stack Developer</strong> with
            a passion for building innovative web solutions. My journey into
            development started with a fascination for creating dynamic,
          ...
          >
            ...
            new technologies, contributing to open-source projects, or staying
