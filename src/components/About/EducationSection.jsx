...
const education = [
  {
    ...
    duration: 'Jul 2024',
    location: 'Modasa',
    description: 'Completed Bachelor of Engineering degree with focus on computer science and engineering principles.'
  },
  {
    degree: 'Science',
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold text-primary mb-6 text-center">
        <GraduationCap className="inline-block mr-2 text-primary" size={30} /> Education
      </h2>
      <div className="space-y-8">
        {education.map((edu, index) => (
          ...
          >
            ...
            <p className="text-primary text-lg mb-2">{edu.institution} <span className="text-gray-500 dark:text-gray-400 text-base ml-2">• {edu.duration} • {edu.location}</span></p>
