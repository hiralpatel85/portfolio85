      ...
      <Card className="h-full flex flex-col justify-between rounded-2xl shadow-lg hover:shadow-md transition-all duration-300 border-gray-200 dark:border-gray-700 bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 overflow-hidden group">
        ...
        <CardFooter className="p-6 pt-0 flex justify-start gap-3">
          {project.liveLink && (
            ...
            >
              <Button
                className="bg-gradient-to-r from-primary to-accent text-white hover:from-primary-hover hover:to-accent/80 rounded-lg px-4 py-2 text-sm shadow-sm hover:shadow-md transition-all duration-300 group/btn"
          ...
          {project.githubLink && (
            ...
            >
              <Button
                variant="outline"
                className="border-2 border-primary text-primary hover:bg-primary/10 dark:hover:bg-primary/20 rounded-lg px-4 py-2 text-sm shadow-sm hover:shadow-md transition-all duration-300 group/btn"
